...
const Login = () => {
  ...
  const submitHandler = (e) => {
    ...
    let url;
    if (isLogin) {
      url="https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDoLP-RSyOJsvlCv1l_VgNuB3ObXZaWVew"
    } else {
      url="https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDoLP-RSyOJsvlCv1l_VgNuB3ObXZaWVew";
    }
    fetch(url,{
      method:'POST',
      body:JSON.stringify({
